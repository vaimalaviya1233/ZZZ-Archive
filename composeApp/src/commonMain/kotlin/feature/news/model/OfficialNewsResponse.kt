...
@Serializable
data class OfficialNewsDataResponse(val iTotal: Int? = null, val list: List<OfficialNewsListItemResponse>? = null)
...
val stubNewsListItem =
    OfficialNewsListItemResponse(
        sChanId = listOf("296"),
...
val stubOfficialNewsDataResponseResponse =
