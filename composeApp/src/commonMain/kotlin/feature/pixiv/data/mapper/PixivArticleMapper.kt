...
fun PixivTopicResponse.toPixivArticleList(): List<PixivArticleItem> {
    return this.body?.illustManga?.data?.map { recentArticle ->
        PixivArticleItem(
            ...
            artworkUrl = if (recentArticle.id == null) "https://www.pixiv.net"
            else "https://www.pixiv.net/artworks/${recentArticle.id}",
            ...
            profileUrl = if (recentArticle.userId == null) "https://www.pixiv.net"
            else "https://www.pixiv.net/users/${recentArticle.userId}",
